...
class Form extends SISTER_Controller
{
    /**
    ==========================
    ...
    **/
	...
	public function index() 
	{
        ...
        $data['body']['option']['stylesheet'][0] = base_url().'assets/modules/jquery-ui-1.12.1/jquery-ui.theme.min.css';
        ...
        $data['body']['option']['js'][1] = base_url().'assets/modules/jquery-ui-1.12.1/jquery-ui.min.js';
        $data['body']['option']['js'][2] = base_url().'assets/modules/form-builder/form-builder.min.js';
        $data['body']['option']['js'][3] = base_url().'assets/modules/form-builder/form-render.min.js';
        $data['body']['option']['js'][4] = base_url().'assets/scripts/portal/manage_form.js';
        
        $data['body']['content'] = $this->load->view('portal/contents/administrator/forms/index', $data['content'], TRUE);
