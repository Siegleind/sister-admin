...
class Site extends SISTER_Controller
{
    ...
    public function index()
    {
        ...
        $data['body']['option']['stylesheet'][3] = base_url()."assets/modules/fa-iconpicker/css/fontawesome-iconpicker.min.css";
        $data['body']['option']['stylesheet'][4] = base_url().'assets/css/manage_user.css';
        ...
        $data['body']['option']['js'][3] = base_url()."assets/modules/fa-iconpicker/js/fontawesome-iconpicker.min.js";
        $data['body']['option']['js'][4] = base_url().'assets/scripts/portal/manage_site.js';
