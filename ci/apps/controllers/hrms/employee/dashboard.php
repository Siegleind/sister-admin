...
class Dashboard extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('hrms/admin_model', 'admin_model');
               
        
        $this->load->model('hrms/emp_model');
        $this->load->model('hrms/global_model');
        $this->load->model('hrms/mailbox_model');
        $this->load->helper(['ckeditor', 'url', 'alert_helper']);
    ...
    public function index()
    {
        ...
        // get public holiday
        $public_holiday = count($this->total_attendace_in_month($employee_id));
        ...
        $data['subview'] = $this->load->view('hrms/employee/main_content', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function leave_application() {
        ...
        $data['subview'] = $this->load->view('hrms/employee/emp_leave_application', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function apply_leave_application() {
        ...
        $data['subview'] = $this->load->view('hrms/employee/apply_new_leave_application', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function save_leave_application() {
        ...
        redirect('hrms/employee/dashboard/leave_application');
    }
    ...
    public function all_notice() {
        ...
        $data['subview'] = $this->load->view('hrms/employee/all_notice', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function notice_detail($id) {
        ...
        $data['subview'] = $this->load->view('hrms/employee/notice_details', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function all_events() {
        ...
        $data['subview'] = $this->load->view('hrms/employee/events', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function event_detail($id) {
        ...
        $data['subview'] = $this->load->view('hrms/employee/event_details', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function all_award() {
        ...
        $data['subview'] = $this->load->view('hrms/employee/all_awards', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function award_detail($id) {
        ...
        $data['subview'] = $this->load->view('hrms/employee/award_details_page', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function profile() {
        ...
        $data['subview'] = $this->load->view('hrms/employee/user_profile', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function inbox() {
        ...
        $data['subview'] = $this->load->view('hrms/employee/emp_inbox', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function read_inbox_mail($id) {
        ...
        $data['subview'] = $this->load->view('hrms/employee/emp_read_mail', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function delete_inbox_mail() {
        ...
        set_message($type, $message);
        redirect('hrms/employee/dashboard/inbox');
    }
    ...
    public function sent() {
        ...
        $data['subview'] = $this->load->view('hrms/employee/emp_sent', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function read_send_mail($id) {
        ...
        $data['subview'] = $this->load->view('hrms/employee/dashboard/emp_read_mail', $data, TRUE);
        $this->load->view(hrms/'employee/_layout_main', $data);
    }
    ...
    public function delete_send_mail() {
        ...
        set_message($type, $message);
        redirect('hrms/employee/dashboard/sent');
    }
    ...
    public function compose() {
        ...
        $data['subview'] = $this->load->view('hrms/employee/emp_compose_mail', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function send_mail() {
        ...
        foreach ($all_email as $v_email) {
            ...
            if (!empty($_FILES['attach_file']['name'])) {
                ...
                $val == TRUE || redirect('hrms/employee/emp_compose_mail');
            ...
            // set view page
            $view_page = $this->load->view('hrms/employee/read_mail', $data, TRUE);
    ...
    public function change_password() {
        ...
        $data['subview'] = $this->load->view('hrms/employee/change_password', $data, TRUE);
        $this->load->view('hrms/employee/_layout_main', $data);
    }
    ...
    public function set_password() {
        ...
        set_message($type, $message);
        redirect('hrms/employee/dashboard/change_password'); //redirect page
    }
