 ...
 * @author pc mart ltd
 */
class Dashboard extends SISTER_Controller {

    public function __construct() {
        
        parent::__construct();
        $this->load->library(['Session','menu', 'breadcrumbs']);
        $this->load->helper(['url','alert_helper']);
    ...
    public function index() {
        ...
        $data['subview'] = $this->load->view('hrms/admin/main_content', $data, TRUE);
