 ...
 * @author NaYeM
 */
class Department extends SISTER_Controller
{

    public function __construct() {
        parent::__construct('hrms');
        $this->load->model('hrms/department_model');
    }
    public function department_list()
    {
        $this->load->helper(['alert','admin']);
        $this->load->library(['menu', 'breadcrumbs','language']);
    ...
    public function add_department($id = NULL) {
        ...
        if ($id) { // retrive data from db by id
            ...
            if (empty($data['department_info'])) {
                ...
                redirect('hrms/admin/department/add_department');
            }
        }

        //page load
        $data['subview'] = $this->load->view('hrms/admin/department/add_department', $data, TRUE);
        $this->load->view('hrms/admin/_layout_main', $data);
    }
    ...
    public function save_department($id = NULL)
    {
        ...
        set_message($type, $message);
        redirect('hrms/admin/department/department_list'); //redirect page
    }
    ...
    public function delete_designation($dept_id, $id){         
        ...
        set_message($type, $message);
        redirect('hrms/admin/department/add_department/' . $dept_id); //redirect page
    }
