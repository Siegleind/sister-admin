...
class Settings extends SISTER_Controller {

    public function __construct() {
        parent::__construct('hrms');
        $this->load->model('hrms/settings_model');
    ...
    public function general_settings($val = NULL) {
        ...
        $data['subview'] = $this->load->view('hrms/admin/settings/general_settings', $data, TRUE);
        $this->load->view('hrms/admin/_layout_main', $data); //page load
    }
    ...
    public function update_profile() {
        ...
        $data['subview'] = $this->load->view('hrms/admin/settings/update_profile', $data, TRUE);
