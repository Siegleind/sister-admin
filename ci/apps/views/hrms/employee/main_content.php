                ...
                <div class="col-md-3">
                    <div class="panel panel-info" style="border: 1px solid #004884 ">
                        <div class="panel-body">
                            ...
                            <?php else: ?>
                                <img src="<?php echo base_url() ?>/assets/hrms/img/user.jpg" style="height: 200px; width: 210px; "  class="img-responsive center-block" alt="Employee_Image" />
                            <?php endif; ?>
                        </div>
                ...
                <div class="col-md-5">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h2 class="panel-title "><i class="fa fa-user"></i> <strong>Personal Details </strong><span class="pull-right"><a href="<?php echo base_url() ?>hrms/employee/dashboard/profile" class="view-all-front">View Profile</a></span></h2>
                        </div>
                        <div class="panel-body">
