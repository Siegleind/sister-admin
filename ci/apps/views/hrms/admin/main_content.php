<link href="<?php echo base_url() ?>assets/hrms/css/fullcalendar.css" rel="stylesheet" type="text/css" >
<style type="text/css">
        ...
        <div class="row">
            <div class="col-sm-7">      
                ...
                <div class="wrap-fpanel margin">                           
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo 'Upcoming Birhday' ?> - <?php echo date("F"); ?></h3>
                        </div>               
...
<?php endforeach ?>
    ...
    <script src="<?php echo base_url(); ?>assets/hrms/js/fullcalendar.js"></script>
    <script src="<?php echo base_url(); ?>assets/hrms/js/jquery-ui.min.js"></script>
    <!-- / Chart.js Script -->
    <script src="<?php echo base_url(); ?>assets/hrms/js/chart.min.js" type="text/javascript"></script>
