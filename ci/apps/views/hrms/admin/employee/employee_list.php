...
<h4><?php echo anchor('hrms/admin/employee/add_employee', '<i class="fa fa-plus"></i> Add Employee'); ?></h4>
<br/>
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        ...
                        <div class="pull-right hidden-print">                                                                      
                            <span></span>
                            <span><?php echo btn_pdf('hrms/admin/employee/employee_list_pdf'); ?></span>
                        ...
                        <?php if (!empty($all_employee_info)): foreach ($all_employee_info as $v_employee) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>                                
                                    <td class="hidden-print"><?php echo btn_view('hrms/admin/employee/view_employee/' . $v_employee->employee_id); ?></td>                                
                                    <td class="hidden-print"> 
                                        <?php echo btn_edit('hrms/admin/employee/add_employee/' . $v_employee->employee_id); ?>
                                        <?php echo btn_delete('hrms/admin/employee/delete_employee/' . $v_employee->employee_id.'/'.$v_employee->employee_bank_id.'/'.$v_employee->document_id); ?>
                                    </td>     
                                </tr>
                                <?php
                            endforeach;
