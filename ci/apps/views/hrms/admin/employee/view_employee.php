                ...
                <div class="row">
                    <div  class="col-lg-12 panel-title">
                        ...
                        <div class="pull-right">                               
                            <span><?php echo btn_edit('hrms/admin/employee/add_employee/' . $employee_info->employee_id); ?></span>
                            <?php echo btn_pdf('hrms/admin/employee/make_pdf/' . $employee_info->employee_id); ?></span>
                            <button class="margin btn-print" type="button" data-toggle="tooltip" title="Print" onclick="printDiv('printableArea', event)"><?php echo btn_print(); ?></button>                                                              
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    function printDiv(printableArea,e) {
        e.preventDefault();
