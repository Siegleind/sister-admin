        ...
        <div class="wrap-fpanel">
            <div class="panel panel-default" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form  id="form_validation" action="<?php echo base_url() ?>hrms/admin/department/save_department/<?php
                        ...
                        <div id="add_new" class="margin">
                            <?php if (!empty($designation_info)): foreach ($designation_info as $v_designation) : ?>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">                            
                                            <?php echo btn_delete('hrms/admin/department/delete_designation/' . $v_designation->department_id . '/' . $v_designation->designations_id); ?>
                                        </div>
                                    </div>
