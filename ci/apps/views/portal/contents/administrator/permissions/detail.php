                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="<?=base_url()?>administrator/permission">Permission</a></li>
                            <li class="active">Namanya</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <script>
        var table_data_src = '<?=base_url()?>restful/permission/list_paged';
        var submit_url = '<?=base_url()?>restful/permission/do';
        var info_url = '<?=base_url()?>restful/permission/detail/';
    </script>