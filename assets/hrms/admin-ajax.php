<script language="javascript" type="text/javascript">
    ...
    function check_duplicate_emp_id(val) {
        ...
        var strURL = base_url + "hrms/admin/global_controller/check_duplicate_emp_id/" + val;
        var req = getXMLHTTP();
        if (req) {
    ...
    function get_employee_by_designations_id(designation_id) {
        var base_url = '<?= base_url() ?>';
        var strURL = base_url + "hrms/admin/global_controller/get_employee_by_designations_id/" + designation_id;
        var req = getXMLHTTP();
        if (req) {
            req.onreadystatechange = function() {
                if (req.readyState == 4) {
    ...
    function check_current_password(val) {
        var base_url = '<?= base_url() ?>';
        var strURL = base_url + "hrms/admin/global_controller/check_current_password/" + val;
        var req = getXMLHTTP();
        if (req) {
            req.onreadystatechange = function() {
                if (req.readyState == 4) {
    ...
    function check_employee_password(val) {
        ...
        var base_url = '<?= base_url() ?>';
        var strURL = base_url + "hrms/employee/dashboard/check_employee_password/" + val;
